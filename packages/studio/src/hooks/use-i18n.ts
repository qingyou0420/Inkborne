...
const strings = {
  ...
  "nav.projectSettings": { zh: "配置", en: "Configuration" },
  ...
  "dash.subtitle": { zh: "打开一本书进入本书", en: "Open a book to enter its overview" },

  "cockpit.title": { zh: "打开本书", en: "Open this book" },
  "home.toWrite": { zh: "落笔", en: "Write" },
  "home.delete": { zh: "删除", en: "Delete" },
  "cockpit.nextChapter": { zh: "下一章", en: "Next chapter" },
  "cockpit.writeNext": { zh: "写下一章（旧管线）", en: "Write next (legacy)" },
  "cockpit.outline": { zh: "卷纲", en: "Volume map" },
  "cockpit.weave": { zh: "织卷", en: "Weave" },
  "cockpit.manuscript": { zh: "正文", en: "Manuscript" },
  ...
  "book.goWeave": { zh: "去织卷生成章概要", en: "Weave chapter summaries" },
  ...
  "book.uploadCover": { zh: "上传封面", en: "Upload cover" },
  "book.replaceCover": { zh: "更换封面", en: "Replace cover" },
  "book.removeCover": { zh: "移除封面", en: "Remove cover" },
  ...
  "logs.noActivity": { zh: "AI 还没动笔。去落笔写下一章，这里会实时显示进度。", en: "The AI has not started yet. Write the next chapter and progress will appear here." },
  ...
  "book.truthFiles": { zh: "原始资料", en: "Source files" },
  ...
  // Project Settings
  "settings.title": { zh: "配置", en: "Configuration" },
  ...
  "settings.modelsTab": { zh: "模型", en: "Models" },
  ...
  "home.stageWeavePurpose": { zh: "规划分卷与章概要", en: "Plan volumes and chapter briefs" },
  ...
  "home.emptyHint": { zh: "先与问心讨论故事框架，整理正典，再进入设定、卷纲与正文创作。", en: "Talk through the story with Ask, form the canon, then move to settings, volume map, and prose." },
  ...
  "weave.bookOutline": { zh: "本书规划", en: "Book plan" },
  "ground.focusEntry": { zh: "编辑此条", en: "Edit this entry" },

  // Truth Files extras
  "truth.title": { zh: "原始资料", en: "Source files" },
  ...
  "reader.openingManuscript": { zh: "打开正文中…", en: "Opening manuscript..." },
  "reader.manuscriptPage": { zh: "正文页", en: "Manuscript Page" },
